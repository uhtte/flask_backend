...
class Config:
    ...
    PATH_DATABASE = os.path.normpath(
        os.path.join(basedir, '../appdata/storage'))
    SSL_CERTFILE = os.path.normpath(os.path.join(
        '/etc/letsencrypt/live/be.aipowered.kro.kr/fullchain.pem'))
    SSL_KEYFILE = os.path.normpath(os.path.join(
        '/etc/letsencrypt/live/be.aipowered.kro.kr/privkey.pem'))
